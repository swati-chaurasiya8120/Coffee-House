...
/*public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        EditText value = (EditText)findViewById(R.id.name_text_view);

        String name = value.getText().toString();
        String price = createOrderSummary((quantity*(5 + count)),hasWhippedCream.isChecked(),hasChocolate.isChecked(),name);

        Intent intent = new Intent(Intent.ACTION_SENDTO);
        intent.setData(Uri.parse("mailto:"));//Only email app handle it
   ...
   private String createOrderSummary(int orderSummary,boolean hasWhipped,boolean hasChocolate,String name)
   {
      //  String pricemsg = getString(R.string.order_summary_name) +" "+ name;
        //pricemsg += "\n" + getString(R.string.order_summary_whipped_cream) +" "+ hasWhipped;
        //pricemsg += "\n" + getString(R.string.order_summary_chocolate) + hasChocolate;
        //pricemsg += "\n" + getString(R.string.order_summary_quantity) + quantity;
       // pricemsg += "\n" + getString(R.string.order_summary_price) + orderSummary;
